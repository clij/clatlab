...
function clatlab_ = init_clatlab()
    if (exist('net.haesleinhuepf.clatlab.CLATLAB') ~= 8)
        ...
        javaaddpath(strcat(clatlab_folder, 'clatlab-0.3.0.jar'));
        javaaddpath(strcat(clatlab_folder, 'bridj-0.7.0.jar'));
        javaaddpath(strcat(clatlab_folder, 'clij_-1.3.0.jar'));
        javaaddpath(strcat(clatlab_folder, 'clij-clearcl-0.9.1.jar'));
        javaaddpath(strcat(clatlab_folder, 'clij-core-1.3.0.jar'));
        ...
        javaaddpath(strcat(clatlab_folder, 'clij-advanced-filters_-0.10.0.jar'));
